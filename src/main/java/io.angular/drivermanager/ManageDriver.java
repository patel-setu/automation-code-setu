package io.angular.drivermanager;


import io.angular.propertyreader.PropertyReader;
...
public class ManageDriver {
    ...
    public void selectBrowser(String browser) {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20)); //to give the implicittime
        driver.get(baseUrl); // to get the url
    }
